...
price decimal,
coffee_origin varchar(25)
);
insert into products(product_id,product_name,price,coffee_origin)
values (1,'espresso',2.50,'brazil'), 
(2,'macchiatto',3.00,'brazil'),
(3,'cappuccino',3.50,'costa rica'),
(4,'latte',3.50,'indonesia'),
(5,'americano',3.00,'brazil'),
(6,'flat white',3.50,'indonesia'),
(7,'filter',3.00,'india'),
(8,"affogato",2.70,"Italy"),
(9,"Frappe",3.50,"Greece");

select product_name from products
where coffee_origin in("india","indonesia");
...
insert into Orders_nf(order_id,customer_name,product_name) values
(1,"ram","pen"),
(1,"ram","pencil"),
(2,"rekhs","laptop"),
(2,"rekha","mobile");
...
product_id int ,
saledate date,
foreign key (product_id) references Products_nf(product_id)
);
